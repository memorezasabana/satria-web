...
function initMap() {
    // Opsi default jika lokasi tidak dapat diakses
    const defaultLocation = { lat: -7.257472, lng: 112.752088 }; // Surabaya

    // Inisialisasi peta pada posisi default
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
            ...
            (error) => {
                ...
                alert("Tidak dapat mengakses lokasi, menggunakan lokasi default.");
            }
        );
    } else {
        alert("Browser Anda tidak mendukung Geolocation. Menampilkan lokasi default.");
    }
}
